...
//ahora viene la parte del movimiento, para ello debemos de entender que cada pieza es un hueco realmente dentro de la matriz, y lo unico que se esta intercambiando son las posiciones de la matriz, significa que cuando yo teclee las flechas de navegacion debo de saber cual se presiono
...
function moverEnDireccion(direccion){
    ...
    //tengo que mandar a llamar a que la posicion sea valida y si no intercambiarla
    if(posicionValida(nuevaFilaPiezaVacia,nuevaColumnaPiezaVacia)){
        //tengo que hacer una funcion que intercambie las posiciones
...
//necesitamos saber que teclas esta opimiendo el jugador
